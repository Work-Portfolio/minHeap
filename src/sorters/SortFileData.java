...
public class SortFileData
{
	...
	{		
		...
		for (int i = 0; i < numOfChunks-1; i+=1)
		{
	...
	public static void main(String[] args) 
	{
		...
		final String [] fileNames = {"numbers01.txt", "numbers02.txt", "numbers03.txt", "numbers04.txt", "numbers05.txt"};
		...
		// NOTE: When ENABLE_DEBUG_PHASE02 display the elements of minHeap to console at each iteration.
		//       That is when your implementation is ready to dump the minHeap to the output file, print
		//       the elements in minHeap to console. Write the elements to the output file. Finally, clear
		//       the contents of minHeap in preperation for the next iteration.
		MinHeapArrayMerger.mergeSortedArrays(fileChunksAsArrays, minHeap, filePath + outputFileName, ENABLE_DEBUG_PHASE02);
